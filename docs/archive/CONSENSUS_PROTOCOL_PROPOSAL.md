> **Archived: 2026-06-19**
> **Status:** superseded as an active LLM-DocKit roadmap item.
>
> LLM-DocKit no longer owns consensus/runtime orchestration. ForgeOS owns the
> live runtime surface for LMConsole, ProtocolEngine, VisualWorkbench,
> WorkEpisode, AuthorityEngine, and related operator-facing orchestration.
> `llm-council` owns the curated deliberation archive/corpus under
> `raw/<topic>/`: synthesized deliberations, fixtures, lessons, and examples.
>
> This document is kept as historical lineage of LLM-DocKit's 2026-05-03
> exploration of the deliberation primitive. LLM-DocKit retains only the
> durable registry substrate: `REVIEWS.md`, `DECISIONS.md`, `HISTORY.md`,
> `HANDOFF.md`, Trace, validators, hooks, and sync. See
> `docs/llm/DECISIONS.md` D-011.
...
implementer: |
  Superseded as active LLM-DocKit work by D-011. Future live
  runtime/orchestration work belongs to ForgeOS; future corpus curation
  belongs to llm-council. This document remains lineage only.
---
